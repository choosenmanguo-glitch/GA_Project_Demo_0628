...
const typeTagMap: Record<string, { color: string; icon: React.ReactNode }> = {
  '内置': { color: 'purple', icon: <NodeIndexOutlined /> },
...
const ToolsPage: React.FC = () => {
  ...
  const statItems: StatCardItem[] = [
    ...
    { title: '内置工具', value: data.filter((d) => d.type === '内置').length, color: '#722ed1' },
  ...
  return (
    <>
      <div style={{ flex: 1, padding: '16px 24px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <PageHeader
          title="工具管理"
          hint="管理智能体可调用的工具/函数，包括内置工具、API工具和工作流。工具可在智能体配置中挂载，扩展智能体能力边界。"
        />
