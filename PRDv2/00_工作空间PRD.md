...
| v1.1 | 2026-07-17 | 郭泉江 | 新增 | 新增 P00 个人空间初始化页：首次进入开发中心时展示欢迎页，一键创建个人空间 | 4.1 / 4.3 / 5.0 / 5.1 / 5.2.0 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **P00** | **开发中心/个人空间初始化** | Page | /dev/init | 首次进入开发中心的初始化欢迎页，创建个人空间 | 5.2.0 | ✅ |
| **P01** | **开发中心/空间切换触发器** | Trigger | 开发中心侧边栏 | 展示当前空间头像+名称，点击打开弹窗 | 5.2.1 | ✅ |
...
| **P03** | **开发中心/空间管理页** | List/Tabs | /manage/space-manage | 3Tab：空间管理+待审批+审批记录 | 5.4.1 | ✅ |
